...
public class EnhancedListView extends ListView {
    ...
    /**
     * The callback interface used by {@link #setDismissCallback(de.timroes.android.listview.EnhancedListView.OnDismissCallback)}
     ...
     * {@link de.timroes.android.listview.EnhancedListView.OnDismissCallback#onDismiss(de.timroes.android.listview.EnhancedListView, int)}
     * to let the user undo the deletion you've done with your {@link de.timroes.android.listview.EnhancedListView.OnDismissCallback}.
    ...
    public abstract static class Undoable {
         ...
         * {@link de.timroes.android.listview.EnhancedListView.OnDismissCallback#onDismiss(de.timroes.android.listview.EnhancedListView, int)} and reinsert
     ...
     * from {@link de.timroes.android.listview.EnhancedListView.OnDismissCallback#onDismiss(de.timroes.android.listview.EnhancedListView, int)}.
     ...
     * @throws java.lang.IllegalStateException when you haven't passed an {@link de.timroes.android.listview.EnhancedListView.OnDismissCallback}
     *      to {@link #setDismissCallback(de.timroes.android.listview.EnhancedListView.OnDismissCallback)} before calling this
     *      method.
     */
     ...
     * By default this is set to {@link de.timroes.android.listview.EnhancedListView.SwipeDirection#BOTH} so that an item
     ...
     * {@link de.timroes.android.listview.EnhancedListView.Undoable#discard()} might not be called for several items, what might
     ...
     * @throws java.lang.IllegalStateException when this method is called before an {@link de.timroes.android.listview.EnhancedListView.OnDismissCallback}
